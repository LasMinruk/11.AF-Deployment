      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 bg-[#1877f2] text-white p-4 sm:p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center gap-2 sm:gap-0"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          >
            <FaArrowUp className="text-xl sm:text-lg" />
            <span className="text-sm font-medium sm:hidden">Top</span>
          </motion.button>
        )}
      </AnimatePresence>
    </motion.div>
